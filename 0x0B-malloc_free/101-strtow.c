...
/**
 * word_len - it locates the index marking the end of
...
/**
 * count_words - it counts the number of words within a string
 * @str: it is the string to be searched
 ...
 * @str: is the string to be splited
